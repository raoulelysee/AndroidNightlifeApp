...
import com.example.admin.mon1ernightlife.NightApp;

import org.json.JSONArray;
import org.json.JSONObject;

public final class FriendsList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NightApp app = (NightApp) getApplication();
    ...
    protected void onResume() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(GITHUB_JSON_URL,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(FriendsList.this, "Error while getting JSON: " + volleyError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
        );
        request.setTag(this);
